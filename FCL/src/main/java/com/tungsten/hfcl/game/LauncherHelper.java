 ...
 */
package com.tungsten.hfcl.game;

import static android.content.Context.MODE_PRIVATE;
import static com.tungsten.hfcl.util.AndroidUtils.getLocalizedText;
import static com.tungsten.hfcl.util.AndroidUtils.hasStringId;
...
import com.tungsten.hfcl.HFCLApplication;
import com.tungsten.hfcl.R;
import com.tungsten.hfcl.activity.JVMActivity;
import com.tungsten.hfcl.activity.MainActivity;
import com.tungsten.hfcl.control.MenuType;
...
import com.tungsten.hfcl.setting.VersionSetting;
...
import com.tungsten.hfclcore.download.MaintainTask;
import com.tungsten.hfclcore.download.game.GameAssetIndexDownloadTask;
import com.tungsten.hfclcore.download.game.GameVerificationFixTask;
import com.tungsten.hfclcore.download.game.LibraryDownloadException;
...
import com.tungsten.hfclcore.task.DownloadException;
...
import com.tungsten.hfclcore.util.LibFilter;
...
import com.tungsten.hfclcore.util.versioning.VersionNumber;
                ...
                .thenComposeAsync(authInfo -> Task.supplyAsync(() -> {
                        ...
                        .thenComposeAsync(fclBridge -> {
                            ...
                            if (context.getSharedPreferences("launcher", MODE_PRIVATE).getBoolean("autoExitLauncher", false)) {
                                Activity activity = HFCLApplication.getCurrentActivity();
                                if (activity != null)
                                    activity.finish();
                            }
                        }))
