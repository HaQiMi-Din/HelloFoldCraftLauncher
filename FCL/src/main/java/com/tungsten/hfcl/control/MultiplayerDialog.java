...
import com.tungsten.hfcl.terracotta.TerracottaNodeList;
import com.tungsten.hfcl.terracotta.TerracottaState;
import com.tungsten.hfcl.terracotta.profile.TerracottaProfile;
            ...
            ((FCLImageView) findViewById(R.id.difficulty_icon)).imageProperty().bind(Bindings.createObjectBinding(() -> {
                if (Terracotta.stateProperty().get() instanceof TerracottaState.GuestStarting &&
                    ...
                    if (((TerracottaState.GuestStarting) Terracotta.stateProperty().get()).getDifficulty() == TerracottaState.GuestStarting.Difficulty.EASIEST ||
                        ...
                        return AppCompatResources.getDrawable(context, com.tungsten.hfcl.R.drawable.ic_baseline_info_24);
                return AppCompatResources.getDrawable(context, com.tungsten.hfcl.R.drawable.ic_baseline_warning_24);
            }, Terracotta.stateProperty()));
