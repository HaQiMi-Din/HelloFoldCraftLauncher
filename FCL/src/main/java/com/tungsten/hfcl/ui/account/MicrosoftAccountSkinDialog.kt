...
import com.tungsten.hfcl.databinding.DialogMicrosoftAccountSkinBinding
...
import com.tungsten.hfclcore.auth.microsoft.MicrosoftService.MinecraftProfileResponseCape
...
class MicrosoftAccountSkinDialog(
    ...
    private fun showError(e: Exception) {
        ...
        builder.setMessage(
            com.tungsten.hfcl.setting.Accounts.localizeErrorMessage(context, e)
        )
