...
import com.tungsten.hfcl.activity.ControllerActivity;
...
import com.tungsten.hfcl.util.LayoutConverter;
...
public class ControllerManagePage extends FCLCommonPage implements View.OnClickListener {
    ...
    private void shareFile(File file, int chooserTitleRes, String mimeType) {
        ...
        Uri uri = FileProvider.getUriForFile(getContext(), getContext().getString(com.tungsten.hfcl.R.string.file_browser_provider), file);
