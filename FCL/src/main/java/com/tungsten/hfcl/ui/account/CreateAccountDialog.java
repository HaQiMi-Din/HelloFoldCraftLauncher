...
import static com.tungsten.hfcl.setting.Accounts.FACTORY_AUTHLIB_INJECTOR;
import static com.tungsten.hfcl.setting.Accounts.FACTORY_MICROSOFT;
import static com.tungsten.hfcl.setting.Accounts.FACTORY_OFFLINE;
...
import com.tungsten.hfclcore.auth.CharacterSelector;
import com.tungsten.hfclcore.auth.NoSelectedCharacterException;
import com.tungsten.hfclcore.auth.OAuth;
...
import com.tungsten.hfclcore.auth.yggdrasil.GameProfile;
import com.tungsten.hfclcore.auth.yggdrasil.YggdrasilService;
                    ...
                    .whenComplete(Schedulers.androidUIThread(), account -> {
                        ...
                        if (exception instanceof NoSelectedCharacterException || exception instanceof CancellationException) {
                            ...
                            new FCLAlertDialog.Builder(getContext())
                                    ...
                                    .setCancelable(false)
                                    .setNegativeButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_positive), null)
                                    .useAutoLink()
                                    .create()
                                    .show();
                        }
