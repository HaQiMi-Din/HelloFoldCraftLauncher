...
import com.tungsten.hfcllibrary.component.FCLCheckBoxTreeAdapter;
import com.tungsten.hfcllibrary.component.FCLCheckBoxTreeItem;
            ...
            public void onStop(boolean success, TaskExecutor executor) {
                Schedulers.androidUIThread().execute(() -> {
                    if (success) {
                        ...
                        builder1.setNegativeButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_positive), () -> ManagePageManager.getInstance().dismissAllTempPagesCreatedByPage(ManagePageManager.PAGE_ID_MANAGE_MANAGE));
                        ...
                        builder1.setNegativeButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_positive), null);
                        builder1.create().show();
                    }
