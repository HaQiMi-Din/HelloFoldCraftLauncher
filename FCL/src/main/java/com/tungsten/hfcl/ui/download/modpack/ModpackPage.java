...
public abstract class ModpackPage extends FCLTempPage implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == install) {
            ...
            dialog.setPositiveButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_positive), this::onInstall);
            dialog.setNegativeButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_negative), null);
            dialog.show();
        }
        if (v == describe) {
            onDescribe();
