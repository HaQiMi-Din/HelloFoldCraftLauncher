...
import com.tungsten.hfcl.game.ManuallyCreatedModpackException;
import com.tungsten.hfcl.game.ModpackHelper;
...
import com.tungsten.hfcl.ui.download.version.VersionInstallInfoPage;
                ...
                public void onStop(boolean success, TaskExecutor executor) {
                    Schedulers.androidUIThread().execute(() -> {
                        if (success) {
                            ...
                            builder1.setNegativeButton(context.getString(com.tungsten.hfcl.R.string.dialog_positive), () -> {
                                if (update) {
