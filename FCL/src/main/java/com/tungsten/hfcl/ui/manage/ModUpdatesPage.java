...
import com.tungsten.hfclcore.util.io.CSVTable;
    ...
    public static final class ModUpdateObject {
        ...
        public ModUpdateObject(Context context, LocalModFile.ModUpdate data) {
            ...
            switch (data.getCurrentVersion().getSelf().getType()) {
                case CURSEFORGE:
                    source.set(context.getString(com.tungsten.hfcl.R.string.mods_curseforge));
                    break;
                case MODRINTH:
                    source.set(context.getString(com.tungsten.hfcl.R.string.mods_modrinth));
            }
        }
