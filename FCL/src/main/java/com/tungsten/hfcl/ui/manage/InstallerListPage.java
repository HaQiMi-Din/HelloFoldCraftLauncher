...
import static com.tungsten.hfcl.ui.download.version.VersionInstallInfoPage.alertFailureMessage;
...
import com.tungsten.hfcl.ui.InstallerItem;
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            for (InstallerItem installerItem : group.getLibraries()) {
                ...
                installerItem.action.set(() -> {
                    com.tungsten.hfcl.ui.download.version.InstallerListPage page = new com.tungsten.hfcl.ui.download.version.InstallerListPage(getContext(), PageManager.PAGE_ID_TEMP, getParent(), R.layout.page_install_version, gameVersion, libraryId, remoteVersion -> {
            ...
            public void onStop(boolean success, TaskExecutor executor) {
                Schedulers.androidUIThread().execute(() -> {
                    if (success) {
                        ...
                        builder.setNegativeButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_positive), () -> profile.getRepository().onVersionIconChanged.fireEvent(new Event(this)));
                        builder.create().show();
                    } else {
                ...
                public void onStop(boolean success, TaskExecutor executor) {
                    Schedulers.androidUIThread().execute(() -> {
                        if (success) {
                            ...
                            builder1.setNegativeButton(getContext().getString(com.tungsten.hfcl.R.string.dialog_positive), () -> {
