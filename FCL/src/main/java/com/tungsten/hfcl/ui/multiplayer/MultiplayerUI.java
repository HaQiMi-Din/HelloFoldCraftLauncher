package com.tungsten.hfcl.ui.multiplayer;
    ...
    public void onClick(View v) {
        ...
        if (v == shareLog) {
            if (new File(FCLPath.LOG_DIR, "terracotta.log").exists()) {
                ...
                Uri uri = FileProvider.getUriForFile(getContext(), getContext().getString(com.tungsten.hfcl.R.string.file_browser_provider), new File(FCLPath.LOG_DIR, "terracotta.log"));
