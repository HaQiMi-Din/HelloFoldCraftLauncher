...
import com.tungsten.hfcl.fragment.EulaFragment
import com.tungsten.hfcl.fragment.RuntimeFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (sharedPreferences.getBoolean("isAgree", false)) {
            ...
            FCLAlertDialog.Builder(this).apply {
                ...
                setNegativeButton(getString(com.tungsten.hfcl.R.string.crash_reporter_close)) { finish() }
                create().show()
            }
        }
    }
