package com.tungsten.hfcllibrary.component.view.color;
...
public class ColorPickerView extends View {
    ...
    private final static int HUE_PANEL_WIDTH_DP = 20;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        huePanelWidthPx = ConvertUtils.dip2px(getContext(), HUE_PANEL_WIDTH_DP);
        alphaPanelHeightPx = ConvertUtils.dip2px(getContext(), ALPHA_PANEL_HEIGHT_DP);
        panelSpacingPx = ConvertUtils.dip2px(getContext(), PANEL_SPACING_DP);
        circleTrackerRadiusPx = ConvertUtils.dip2px(getContext(), CIRCLE_TRACKER_RADIUS_DP);
        sliderTrackerSizePx = ConvertUtils.dip2px(getContext(), SLIDER_TRACKER_SIZE_DP);
        sliderTrackerOffsetPx = ConvertUtils.dip2px(getContext(), SLIDER_TRACKER_OFFSET_DP);

        requiredPadding = ConvertUtils.dip2px(getContext(), 6);
    ...
    private void initPaintTools() {
        ...
        satValTrackerPaint.setStrokeWidth(ConvertUtils.dip2px(getContext(), 2));
        ...
        hueAlphaTrackerPaint.setStrokeWidth(ConvertUtils.dip2px(getContext(), 2));
        hueAlphaTrackerPaint.setAntiAlias(true);

        alphaTextPaint.setColor(0xff1c1c1c);
        alphaTextPaint.setTextSize(ConvertUtils.dip2px(getContext(), 14));
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        canvas.drawCircle(p.x, p.y, circleTrackerRadiusPx - ConvertUtils.dip2px(getContext(), 1), satValTrackerPaint);
    ...
    private int getPreferredWidth() {
        ...
        int width = ConvertUtils.dip2px(getContext(), 200);

        return (width + huePanelWidthPx + panelSpacingPx);
    }

    private int getPreferredHeight() {
        int height = ConvertUtils.dip2px(getContext(), 200);
    ...
    public int getPaddingTop() {
        return Math.max(super.getPaddingTop(), requiredPadding);
    }

    @Override
    public int getPaddingBottom() {
        return Math.max(super.getPaddingBottom(), requiredPadding);
    }

    @Override
    public int getPaddingLeft() {
        return Math.max(super.getPaddingLeft(), requiredPadding);
    }

    @Override
    public int getPaddingRight() {
        return Math.max(super.getPaddingRight(), requiredPadding);
    }
