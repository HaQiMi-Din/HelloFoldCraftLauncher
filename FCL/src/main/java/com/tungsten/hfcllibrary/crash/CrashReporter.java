package com.tungsten.hfcllibrary.crash;
...
public final class CrashReporter {
    ...
    private static final String EXTRA_CONFIG = "com.tungsten.hfcllibrary.crash.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "com.tungsten.hfcllibrary.crash.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "com.tungsten.hfcllibrary.crash.EXTRA_ACTIVITY_LOG";
    private static final String EXTRA_CUSTOM_CRASH_DATA = "com.tungsten.hfcllibrary.crash.EXTRA_CUSTOM_CRASH_DATA";

    // General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.tungsten.hfcllibrary.crash.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.tungsten.hfcllibrary.crash.RESTART";
    private static final String REPORTER_HANDLER_PACKAGE_NAME = "com.tungsten.hfcllibrary.crash";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.tungsten.hfcllibrary.crash.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.tungsten.hfcllibrary.crash.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.tungsten.hfcllibrary.crash.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.tungsten.hfcllibrary.crash.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
